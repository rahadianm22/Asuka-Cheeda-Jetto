...
export const CHANNEL_STATS = [
  { key: 'subs', value: '18,4K', labelKey: 'ytStatSubs', icon: 'subs', accent: '#e85d8a' },
  { key: 'views', value: '998K', labelKey: 'ytStatViews', icon: 'views', accent: '#c1a1cf' },
  { key: 'contents', value: '224', labelKey: 'ytStatContents', icon: 'contents', accent: '#e85d8a' },
];
